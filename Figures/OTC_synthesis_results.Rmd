...
```{r Calculate phenoperiod lengths, echo=FALSE,  warning=FALSE, error=FALSE, message=F}
...
```{r, echo=FALSE, warning=FALSE, error=FALSE, message=F, results=FALSE,  fig.width=8, fig.height=6}
#Greenup
#Intercepts 

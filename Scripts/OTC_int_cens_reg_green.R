...
save(fit_m2x_green, file="fit_m2x_green.Rdata")
...
save(fit_m3x_green, file="fit_m3x_green.Rdata")
...
save(fit_m4x_green, file="fit_m4x_green.Rdata")
...
save(fit_m5x_green, file="fit_m5x_green.Rdata")
...
save(fit_m6x_green, file="fit_m6x_green.Rdata")
...
save(fit_m7x_green, file="fit_m7x_green.Rdata")
